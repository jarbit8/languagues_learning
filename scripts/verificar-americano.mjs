...
const BRITANICO = [
  ...
  // Calcos y giros que la auditoría del 2026-09-17 encontró a decenas sin que nada los viera.
  [/\b(have|has|having|had) a shower\b/gi, 'take a shower', 'léxico'],
  [/\bmotorbikes?\b/gi, 'motorcycle(s)', 'léxico'],
  [/\b(like|likes|love|loves|hate|hates|prefer|prefers) sport\b/gi, 'sports (en plural)', 'léxico'],
  [/\bbooking\b/gi, 'reservation', 'léxico'],
  [/(?<!from )\b(five|ten|twenty|twenty-five) (past|to)\b/gi, 'la hora digital: three twenty, six forty', 'léxico'],
  [/\bmenu card\b/gi, 'menu', 'léxico'],
  [/\bone can\b/gi, 'you can', 'léxico'],
  [/\ball the (day|night|morning|afternoon|evening|week|year)\b/gi, 'all day / all night (sin the)', 'léxico'],
  [/\bmuch water\b/gi, 'a lot of water', 'léxico'],
  [/\bin the (party|pharmacy)\b/gi, 'at the party / at the pharmacy', 'léxico'],
  [/\b(do|does) (running|swimming)\b/gi, 'run / swim', 'léxico'],
  [/\bthe [a-z]+ of (Marie|Ana|Paul|Laura|Marc|Lee|Maria|Sofia)\b/gi, "Marie's room (genitivo 's, tema 4)", 'léxico'],
