...
export async function corregirWriting(consigna: string, texto: string): Promise<ResultadoCorreccion> {
  try {
    const respuesta = await corregirTexto(systemPromptWriting(consigna), texto)
